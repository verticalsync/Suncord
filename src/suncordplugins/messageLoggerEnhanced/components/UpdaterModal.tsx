...
import { changes, checkForUpdates, getRepoInfo, repoInfo as reInfo, updateError } from "../utils/updater";
...
export function UpdaterModal({ modalProps }: { modalProps: ModalProps; }) {
    ...
    async function onUpdate() {
        Alerts.show({
            ...
            body: "Suncord has disabled updates for messageLoggerEnhanced, as they will not work properly, please contact nyx to update messageLoggerEnhanced.",
            confirmText: "Okay",
        });
