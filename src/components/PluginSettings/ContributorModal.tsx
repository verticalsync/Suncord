...
import { DevsById, SuncordDevsById } from "@utils/constants";
...
function ContributorModal({ user }: { user: User; }) {
    ...
    const plugins = useMemo(() => {
        ...
        const pluginsByAuthor = DevsById[user.id] || SuncordDevsById[user.id]
            ? allPlugins.filter(p => p.authors.includes(DevsById[user.id] || SuncordDevsById[user.id]))
