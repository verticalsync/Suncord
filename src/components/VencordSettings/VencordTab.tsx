...
import { Button, Card, Forms, React, Select, showToast, Switch, TooltipContainer } from "@webpack/common";
...
const OpenGithubIcon = iconWithTooltip(GithubIcon, "View Suncord's GitHub Repository");
