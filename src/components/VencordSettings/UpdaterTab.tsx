...
function Updater() {
    ...
    return (
        <SettingsTab title="Suncord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Suncord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Suncord automatically updates"
